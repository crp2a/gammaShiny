...
[![Appveyor build status](https://ci.appveyor.com/api/projects/status/qb7yvcbc8knvmul9?svg=true)](https://ci.appveyor.com/project/nfrerebeau/gammashiny)
[![Travis build Status](https://travis-ci.org/crp2a/gammaShiny.svg?branch=master)](https://travis-ci.org/crp2a/gammaShiny)
...
A collection of [**shiny**](https://shiny.rstudio.com) applications for the R package [**gamma**](https://github.com/crp2a/gamma).
...
A [**shiny**](https://shiny.rstudio.com) application provides an exhanced graphical user interface:
