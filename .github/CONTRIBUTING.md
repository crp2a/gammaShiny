...
* Look at the [style guide](https://github.com/crp2a/gammaShiny/blob/master/.github/CODING_STYLE.md) before making changes. Please don't restyle code that has nothing to do with your PR.
